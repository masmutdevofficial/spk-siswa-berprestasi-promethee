...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('auth.login.guru') }}" method="POST">
        @csrf
...
<div class="login-box mt-3">
  <div class="card">
    <div class="card-body login-card-body">
        ...
        <ul class="small">
            <li><strong>Guru 1</strong><br>
                Email: <code>guru1@gmail.com</code><br>
                Password: <code>guru1</code>
            </li>
            <li><strong>Guru 2</strong><br>
