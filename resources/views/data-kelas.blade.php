    ...
    <div class="card-body">
        <table id="basicTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            ...
                            <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modalHapus{{ $item->kelas_id }}">
                ...
                <!-- Modal Edit -->
                <div class="modal fade" id="modalEdit{{ $item->kelas_id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form action="{{ url('kelas/update/' . $item->kelas_id) }}" method="POST">
                            @csrf
                ...
                <!-- Modal Hapus -->
                <div class="modal fade" id="modalHapus{{ $item->kelas_id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form action="{{ url('kelas/delete/' . $item->kelas_id) }}" method="GET">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    Yakin ingin menghapus kelas <strong>{{ $item->nama_kelas }}</strong>?
                                </div>
                                <div class="modal-footer">
