                        ...
                        <form action="{{ url('yayasan/update/' . $item->yayasan_id) }}" method="POST">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label>Admin Yayasan</label>
                                        <select name="admin_yayasan_id" class="form-control" required>
                                            @foreach($admin as $a)
                                            <option value="{{ $a->admin_yayasan_id }}" {{ $item->admin_yayasan_id == $a->admin_yayasan_id ? 'selected' : '' }}>
                                                {{ $a->username }}
                                            </option>
                                            @endforeach
                                        </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="admin_yayasan_id" class="form-control" required>
                            @foreach($admin as $a)
                            <option value="{{ $a->admin_yayasan_id }}">{{ $a->username }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
