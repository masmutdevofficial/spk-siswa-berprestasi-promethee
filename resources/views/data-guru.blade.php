    ...
    <div class="card-body">
        <table id="basicTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <button class="btn btn-sm btn-warning mr-2" data-toggle="modal" data-target="#modalEdit{{ $item->user_guru_id }}">
                                <i class="fa fa-edit mr-1"></i>Edit
                            </button>
                            <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modalHapus{{ $item->user_guru_id }}">
                ...
                <!-- Modal Edit -->
                <div class="modal fade" id="modalEdit{{ $item->user_guru_id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form action="{{ url('user-guru/update/' . $item->user_guru_id) }}" method="POST">
                            @csrf
                ...
                <!-- Modal Hapus -->
                <div class="modal fade" id="modalHapus{{ $item->user_guru_id }}" tabindex="-1">
                    <div class="modal-dialog">
                        <form action="{{ url('user-guru/delete/' . $item->user_guru_id) }}" method="GET">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    Yakin ingin menghapus guru <strong>{{ $item->nama }}</strong>?
                                </div>
                                <div class="modal-footer">
...
<div class="modal fade" id="modalTambah" tabindex="-1">
    <div class="modal-dialog">
        <form action="{{ url('user-guru/store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
